    ...
    <div className='py-20' id='projects'>
        ...
        <div className='flex flex-wrap items-center justify-center px-4 gap-x-40  gap-y-8 mt-20'>
            {projects.map(({id, title, des, img, iconLists, link}) => (
                <div key={id} className='mb-40 sm:mb-10 lg:min-h-[32.5rem] h-[15rem] items-center justify-center flex sm:w-[296px] w-[80vw] ' >
                    <PinContainer title={link} href={link}>
                        <div className='relative flex items-center justify-center sm:w-[370px] w-[80vw] overflow-hidden h-[30vh] lg:h-[60vh] mb-6 rounded-md sm:h-[40vh]'>
                            <div className='relative w-full  overflow-hidden lg:rounded-3xl bg-[#13162d]'>
                                <img className='object-cover' src="/bg.png" alt="bg-img" />
                            </div>
                            <img src={img} alt={title} className='z-10 absolute bottom-0 object-cover ' />
                        </div>
